...
public class EntidadesController {
    ...
    private final String INDEX = "entidade/CadastrarEntidade";
    ...
    public String salvar(@Valid Entidade entidade, BindingResult result, RedirectAttributes attributes) {
        ...
        this.entidadesService.salvar(entidade);
    ...
    public ModelAndView pesquisar(Entidade entidade, @PageableDefault(size = 6) Pageable pageable,
        ...
        PageWrapper<Entidade> paginaWrapper = new PageWrapper<>(entidades.porNome(entidade.getNome(), pageable), httpServletRequest);
    ...
    public String excluir(@PathVariable("codigo") Long codigo, RedirectAttributes attributes) {
        ...
        attributes.addFlashAttribute("mensagem", "Entidade excluida com sucesso.");
        return "redirect:/entidades";
    }
