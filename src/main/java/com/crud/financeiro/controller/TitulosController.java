...
import com.crud.financeiro.model.*;
...
public class TitulosController {
    ...
    public ModelAndView pesquisar(Titulo titulo, @PageableDefault(size = 6) Pageable pageable,
        ...
        PageWrapper<Titulo> paginaWrapper = new PageWrapper<>(titulos.filtrados(descricao, titulo.getEntidade(), pageable), httpServletRequest);
    ...
    public @ResponseBody ResponseEntity<?> novoTipoDePagamento(@RequestBody @Valid TipoDePagamento tipoDePagamento,BindingResult result) {
